...
const ForumPost = forwardRef<HTMLDivElement, Props>(function ForumPost(
    { user, post, eventId, onVote }: Props,
    ref
) {
            ...
            >
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <PiArrowFatUp
                            className={cn(
                                userUpvotedPost && "fill-secondary-300"
                            )}
                        />
                    </button>
                    ...
                    >
                        <PiArrowFatDown
                            className={cn(
                                userDownvotedPost && "fill-danger-200"
                            )}
                        />
                    </button>
                </div>
