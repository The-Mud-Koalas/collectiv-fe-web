...
const Header: FC<HeaderProps> = ({}) => {
    return (
        <div className="text-center mx-auto max-w-3xl mt-20 mb-40">
            ...
            >
                <Link
                    href="/event/create"
                    className="bg-primary-900 border border-primary-900 text-primary-200 px-3 py-2 rounded-full"
                >
                    Get Started
                </Link>
                <Link href="#hosting-info">
                    <Button
                        tabIndex={-1}
