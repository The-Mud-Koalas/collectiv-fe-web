...
const EventInfoAndActions = ({ eventDetails }: Props) => {
    ...
    const registerParticipant = useMutation({
        ...
        onSuccess: () =>
            toast.success(
                `You have successfully registed to ${eventDetails.name}.`
            ),
    ...
    const isManagerInProject =
        eventDetails.event_type === "project" && isManager;
    const isAttending =
        ...
        <>
            <section className="flex gap-6 mt-5 xl:flex-row lg:justify-between flex-col">
                <div className="flex flex-col gap-4 xl:w-3/5 w-full">
                    ...
                    <div className="flex items-center lg:gap-5 gap-3 text-gray-500 xl:justify-normal justify-center xl:text-base text-sm lg:flex-nowrap flex-wrap">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <span>
                                {new Date(
                                    eventDetails.event_end_date_time
                                ).toDateString()}
                            </span>
                        </div>
                        <div className="flex items-center gap-1">
                            ...
                            <>
                                ...
                                {isManager && (
                                    <Link
                                        href={
                                            BASE_URL +
                                            "?checkInParticipantOrVolunteer=true"
                                        }
                                        shallow
                ...
                <Button
                    ...
                    className="my-2 px-4 py-2 bg-alert-100 text-danger-500 rounded-full z-10"
                >
                    report
                </Button>
                <ReportModal
